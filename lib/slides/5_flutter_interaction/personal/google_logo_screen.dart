...
class _GoogleLogoScreenState extends State<GoogleLogoScreen>
  ...
  void initState() {
    ...
    _greenAnimation = CurveTween(curve: Curves.linear).animate(
      CurvedAnimation(
        parent: _controller,
        curve: const Interval(0.33, 0.36),
      ),
    );
...
class GooglePainter extends CustomPainter {
  ...
  void paint(Canvas canvas, Size size) {
    ...
    path.arcTo(
      bounds,
      _start,
      math.max(_start, blue * _blueStop),
      blue <= 0,
    );
